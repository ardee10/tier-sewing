...
<main class="app-main">
							...
							<div class="row mb-3 align-items-center">
								<!-- <div class="area-critical" hidden>
									<div class="col-12 col-md-12 float-end">
										<div class="info-box mb-3 text-bg-danger float-end">
											<span class="info-box-icon"> <i class="icofont-truck fw-medium"></i> </span>
											<div class="info-box-content">
												<span class="info-box-text small">
													<h5> CRITICAL DESTINATION </h5>
												</span>
							...
							<div class="row mb-3 align-items-center">
								...
								<div class="col-12 col-md-8 mb-2 mb-md-0">
									<div class="custom-title-box bg-gradient-primary rounded-1">
										<div class="inner">
											<h2 class="text-bold text-uppercase text-white text-center mb-0" style="font-size: 2rem;">
								...
								<div class="col-12 col-md-4">
									<div class="form-group mb-0">
										...
										<input type="hidden" name="factoryFilterHome" id="factoryFilterHome" value="<?= $build ?>">
										<input type="hidden" name="cellFilterHome" id="cellFilterHome" value="<?= $cell ?>">
										<input type="date" name="dateFilterHome" id="dateFilterHome"
											...
											<div class="card card-body bg-primary rounded-1 mb-2 h-80 card-kpi-input p-1">
												...
												<div class="row">
													<div class="col text-right">
														<span class="text-bold text-danger t-shadow-white" id="textDownTime">-</span> min /
													</div>
													<div class="col text-left">
														<span class="text-bold text-danger t-shadow-white" id="textPairDownTime">-</span> pairs
													</div>
												</div>
												<p class="mt-1 text-center text-sm"><a href="#" class="text-white" id="downloadDTCell" style="text-decoration: none;"><i class="icofont-folder-open"></i> Lihat Detil</a></p>
											</div>
										</div>
	...
	<script>
		...
		$(document).ready(function() {
			// Ambil factory, cell, dan date dari input hidden atau form
			let factory = $("#factoryFilterHome").val();
			let cell = $("#cellFilterHome").val();
			let date = $("#dateFilterHome").val();

			// Jalankan pertama kali
			loadDataKpi();

			// Ambil refresh interval dari elemen
			...
			// Jalankan ulang loadDataKpi setiap refreshInterval detik
			setInterval(function() {
				loadDataKpi();
				timerCountdown = refreshInterval; // Reset countdown
				$("#timer").text(refreshInterval);
			}, 1000 * refreshInterval);

			// Event handler untuk ganti factory
			...
			// Event handler untuk ganti cell/date
