			...
			<div class="row mb-3">
				<div class="d-flex justify-content-between w-100">
					...
					<button type="button" class="btn btn-success btn-sm">
						<a href="<?= base_url('Manpower') ?>" class="text-white text-decoration-none">
					...
					<button type="button" class="btn btn-primary btn-sm">
						<a href="<?= site_url('excelfile/master/'); ?>master_mp_actual.xlsx" class="text-white text-decoration-none">
			...
			<div class="row mb-3">
				<div class="col-md-12">
					<div class="card card-primary bg-gradient card-outline">
						<form method="POST" action="<?= site_url('Manpower/upload_mp'); ?>" enctype="multipart/form-data">
							<div class="card-body">
								<!-- Isian disini -->
								<div class="row">
									<div class="col-md-6">
